    ...
    <section className="w-full min-h-screen h-auto grid grid-cols-1 xl:grid-cols-2 border-b-2 border-black/30 dark:border-white/30">
      <div className="w-full flex items-center justify-center">
        <div className="">
          ...
          <h3 className="text-3xl sm:text-3xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-black/100 dark:text-white/100 transition-colors duration-500">I'm <span className={`transition-colors duration-500 ${themeColors[color].text}`}>Pranesh Chaturvedi</span></h3>
