  ...
  return (
    <section className="w-full min-h-screen py-12">
      <div className="w-full h-full flex flex-col items-center justify-center">
        <h1 className={`text-left text-lg sm:text-xl md:text-2xl lg:text-3xl xl:4xl ${themeColors[color].text} font-bold transition-colors duration-500`}>What I Do?</h1>
        <div className="w-10/12 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-4 md:gap-6 lg:gap-6 xl:gap-8 mt-8">
          {services.map((service) => {
            const Icon = service.icon;
            return (
              <div className="py-4 px-2 shadow-md rounded-md flex flex-col items-center justify-center outline outline-black/10 dark:outline-white/20">
