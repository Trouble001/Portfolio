...
const AboutSection = () => {
  return (
    <section className="w-full min-h-screen py-4 xl:py-0 grid gap-8 xl:gap-0 grid-cols-1 xl:grid-cols-2">
      <div className="w-full flex flex-col items-center justify-center">
        <div className="w-11/12">
          <h1 className="text-left text-lg sm:text-xl md:text-2xl lg:text-3xl xl:4xl text-green-600 font-bold">- About Me</h1>
        </div>
        ...
        <div className="w-10/12 mt-4 grid grid-cols-2 text-xs sm:text-sm md:text-base lg:text-md xl:text-md">
          <div>
            ...
            <p className="text-green-600 font-medium mt-2">Age</p>
          ...
          <div>
            ...
            <p className="text-green-600 font-medium mt-2">Address</p>
